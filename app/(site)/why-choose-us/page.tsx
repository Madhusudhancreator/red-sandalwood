import { getWhyChooseUsPageData } from "@/lib/sanity/queries/newPages";
...
export default async function WhyChooseUsPage() {
  const page = await getWhyChooseUsPageData();
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        {page ? (
          ...
          <p className="text-gray-600">
            Discover why farmers across Andhra Pradesh trust our association — coming soon.
          </p>
        )}
      </div>
    </>
